...
namespace TooJpeg
{
  ...
  typedef void (*WRITE_ONE_BYTE)(unsigned char, void *context);
  ...
  bool writeJpeg(WRITE_ONE_BYTE output, void *context, const void* pixels, unsigned short width, unsigned short height,
