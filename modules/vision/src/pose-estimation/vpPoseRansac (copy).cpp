...
//
//
//bool poseRansacConsensusStepImpl(std::vector<vpPoint> &ransacInliers, std::vector<unsigned int> &ransacInlierIndex,
...
//        m_ransacMaxTrials(ransacMaxTrials_), m_ransacInliers(),
//        m_ransacInlierIndex(), m_ransacThreshold(ransacThreshold_),
//        m_initial_seed(initial_seed_), m_func(func_), foundSolution(false) {
//  }
//
//  ransac_functor() :
//        m_listP(), m_cMo(), m_ransacNbInlierConsensus(),
//        m_ransacMaxTrials(), m_ransacInliers(),
//        m_ransacInlierIndex(), m_ransacThreshold(),
...
//      bool foundSolution = false;
//
//      while (nbTrials < m_ransacMaxTrials && nbInliers < (unsigned)m_ransacNbInlierConsensus)
//      {
//        //Hold the list of the index of the inliers (points in the consensus set)
//        cur_consensus.clear();
//
...
//          ransacInliers = ransac_func[i].getRansacInliers();
//          ransacInlierIndex = ransac_func[i].getRansacInlierIndex();
//        }
//      }
//    }
//
...
//    foundSolution = poseRansacConsensusStepImpl(ransacInliers, ransacInlierIndex, listP, ransacMaxTrials,
