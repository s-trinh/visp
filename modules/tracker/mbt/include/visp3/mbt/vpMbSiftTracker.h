...
/*!
 * \file vpMbSiftTracker.h
 * \brief Model based tracker using only KLT
 */

#ifndef _vpMbSiftTracker_h_
#define _vpMbSiftTracker_h_
 ...
 *   vpMbSiftTracker tracker; // Create a model based tracker via KLT points.
 ...
 * \endcode
*/
class VISP_EXPORT vpMbSiftTracker : public virtual vpMbTracker
{
protected:
...
public:
  vpMbSiftTracker();
  virtual ~vpMbSiftTracker();

  /** @name Inherited functionalities from vpMbSiftTracker */
  //@{
  ...
  {
    if (flag)
      std::cerr << "This option is not yet implemented in vpMbSiftTracker, "
...
protected:
  /** @name Protected Member Functions Inherited from vpMbSiftTracker */
  //@{
  void computeVVS();
