...
vpMbTracker::vpMbTracker()
  : cam(), cMo(), oJo(6, 6), isoJoIdentity(true), modelFileName(), modelInitialised(false), poseSavingFilename(),
    ...
    displayFeatures(false), m_optimizationMethod(vpMbTracker::GAUSS_NEWTON_OPT), faces(), angleAppears(vpMath::rad(70)),
    angleDisappears(vpMath::rad(80)), distNearClip(0.001), distFarClip(100), clippingFlag(vpPolygon3D::NO_CLIPPING),
...
/*!
  ...
  \param I : Input color grayscale image
  \param points2D_list : List of image points.
  \param points3D_list : List of 3D points (object frame).
*/
