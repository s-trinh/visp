...
void vpMbTracker::setProjectionErrorKernelSize(const unsigned int &size)
{
  ...
  // // TODO:
  // m_SobelX[0][0] = 3;   m_SobelX[0][1] = 10;   m_SobelX[0][2] = 3;
  // m_SobelX[1][0] = 0;   m_SobelX[1][1] = 0;    m_SobelX[1][2] = 0;
  // m_SobelX[2][0] = -3;  m_SobelX[2][1] = -10;  m_SobelX[2][2] = -3;

  // m_SobelY[0][0] = 3;   m_SobelY[0][1] = 0;    m_SobelY[0][2] = -3;
  // m_SobelY[1][0] = 10;  m_SobelY[1][1] = 0;    m_SobelY[1][2] = -10;
  // m_SobelY[2][0] = 3;   m_SobelY[2][1] = 0;    m_SobelY[2][2] = -3;
