...
/*!
\file vpMatrixf.cpp
\brief Definition of the vpMatrixf class
*/
...
void vpMatrixf::blas_dsyev(char jobz, char uplo, unsigned int n_, double *a_data, unsigned int lda_, double *w_data,
...
const unsigned int vpMatrixf::m_lapack_min_size_default = 0;
unsigned int vpMatrixf::m_lapack_min_size = vpMatrixf::m_lapack_min_size_default;
#endif

// Prototypes of specific functions
vpMatrixf subblock(const vpMatrixf &, unsigned int, unsigned int);

void compute_pseudo_inverse(const vpMatrixf &U, const vpColVectorf &sv, const vpMatrixf &V, unsigned int nrows,
                            unsigned int ncols, double svThreshold, vpMatrixf &Ap, int &rank_out, int *rank_in,
                            vpMatrixf *imA, vpMatrixf *imAt, vpMatrixf *kerAt)
{
...
/*!
  ...
  \sa init(const vpMatrixf &M, unsigned int r, unsigned int c, unsigned int
  nrows, unsigned int ncols)
*/
vpMatrixf::vpMatrixf(const vpMatrixf &M, unsigned int r, unsigned int c, unsigned int nrows, unsigned int ncols)
  : vpArray2D<double>()
{
...
vpMatrixf::vpMatrixf(vpMatrixf &&A) : vpArray2D<double>()
{
  rowNum = A.rowNum;
  colNum = A.colNum;
  rowPtrs = A.rowPtrs;
...
4  5.5  6
   \endcode
 */
vpMatrixf::vpMatrixf(const std::initializer_list<double> &list) : vpArray2D<double>(list) {}
...
4  5.5  6
   \endcode
 */
vpMatrixf::vpMatrixf(unsigned int nrows, unsigned int ncols, const std::initializer_list<double> &list)
...
4  5.5  6
   \endcode
 */
vpMatrixf::vpMatrixf(const std::initializer_list<std::initializer_list<double> > &lists) : vpArray2D<double>(lists) {}
...
N [2,3]=
  ...
  \sa extract()
 */
void vpMatrixf::init(const vpMatrixf &M, unsigned int r, unsigned int c, unsigned int nrows, unsigned int ncols)
{
  unsigned int rnrows = r + nrows;
  unsigned int cncols = c + ncols;

  if (rnrows > M.getRows())
    throw(vpException(vpException::dimensionError, "Bad row dimension (%d > %d) used to initialize vpMatrixf", rnrows,
                      M.getRows()));
  if (cncols > M.getCols())
    throw(vpException(vpException::dimensionError, "Bad column dimension (%d > %d) used to initialize vpMatrixf", cncols,
                      M.getCols()));
...
N [2,3]=
  ...
  \sa init(const vpMatrixf &, unsigned int, unsigned int, unsigned int,
unsigned int)
 */
vpMatrixf vpMatrixf::extract(unsigned int r, unsigned int c, unsigned int nrows, unsigned int ncols) const
{
  unsigned int rnrows = r + nrows;
  unsigned int cncols = c + ncols;
...
*/
void vpMatrixf::eye(unsigned int n) { eye(n, n); }

/*!
  Set an m-by-n matrix to identity with ones on the diagonal and zeros
  else where.
*/
void vpMatrixf::eye(unsigned int m, unsigned int n)
{
  resize(m, n);
...
*/
vpMatrixf vpMatrixf::t() const { return transpose(); }
...
/*!
  ...
  \sa t()
*/
vpMatrixf vpMatrixf::transpose() const
{
  vpMatrixf At;
  transpose(At);
  return At;
...
/*!
  ...
  \sa t()
*/
void vpMatrixf::transpose(vpMatrixf &At) const
{
...
/*!
  ...
  \return  \f$A*A^T\f$
  \sa AAt(vpMatrixf &) const
*/
vpMatrixf vpMatrixf::AAt() const
{
  vpMatrixf B;
...
/*!
  ...
  \sa AAt()
*/
void vpMatrixf::AAt(vpMatrixf &B) const
{
  if ((B.rowNum != rowNum) || (B.colNum != rowNum))
    B.resize(rowNum, rowNum, false, false);

  // If available use Lapack only for large matrices
  bool useLapack = (rowNum > vpMatrixf::m_lapack_min_size || colNum > vpMatrixf::m_lapack_min_size);
  ...
  if (useLapack) {
    ...
    vpMatrixf::blas_dgemm(transa, transb, rowNum, rowNum, colNum, alpha, data, colNum, data, colNum, beta, B.data,
                         rowNum);
#endif
  } else {
    // compute A*A^T
...
/*!
  ...
  \sa AtA()
*/
void vpMatrixf::AtA(vpMatrixf &B) const
{
  ...
  if (useLapack) {
    ...
    vpMatrixf::blas_dgemm(transa, transb, colNum, colNum, rowNum, alpha, data, colNum, data, colNum, beta, B.data,
                         colNum);
#endif
  } else {
...
/*!
  Compute the AtA operation such as \f$B = A^T*A\f$
  \return  \f$A^T*A\f$
  \sa AtA(vpMatrixf &) const
*/
vpMatrixf vpMatrixf::AtA() const
{
  vpMatrixf B;
...
/*!
  ...
  inherit from vpArray2D such as vpMatrixf, vpRotationMatrix,
  vpHomogeneousMatrix, vpPoseVector, vpColVectorf, vpRowVector... into a
  vpMatrixf.
...
*/
vpMatrixf &vpMatrixf::operator=(const vpArray2D<double> &A)
{
...
#if (VISP_CXX_STANDARD >= VISP_CXX_STANDARD_11)
vpMatrixf &vpMatrixf::operator=(const vpMatrixf &A)
{
  resize(A.getRows(), A.getCols(), false, false);
...
vpMatrixf &vpMatrixf::operator=(vpMatrixf &&other)
{
  if (this != &other) {
    free(data);
    free(rowPtrs);
...
-4  -5  -6
  ...
  \sa operator<<()
 */
vpMatrixf &vpMatrixf::operator=(const std::initializer_list<double> &list)
{
...
-4  -5  -6
  ...
  \sa operator<<()
 */
vpMatrixf &vpMatrixf::operator=(const std::initializer_list<std::initializer_list<double> > &lists)
{
...
vpMatrixf &vpMatrixf::operator=(double x)
{
...
vpMatrixf &vpMatrixf::operator<<(double val)
{
...
\endcode
*/
void vpMatrixf::diag(const vpColVectorf &A)
{
...
\endcode
*/
void vpMatrixf::diag(const double &val)
{
  (*this) = 0;
...
void vpMatrixf::createDiagonalMatrix(const vpColVectorf &A, vpMatrixf &DA)
{
  unsigned int rows = A.getRows();
...
/*!
  ...
  */
vpTranslationVector vpMatrixf::operator*(const vpTranslationVector &tv) const
{
...
*/
vpColVectorf vpMatrixf::operator*(const vpColVectorf &v) const
{
  vpColVectorf v_out;
  vpMatrixf::multMatrixVector(*this, v, v_out);
  return v_out;
}
...
/*!
  ...
  \sa operator*(const vpColVectorf &v) const
*/
void vpMatrixf::multMatrixVector(const vpMatrixf &A, const vpColVectorf &v, vpColVectorf &w)
{
  ...
  // If available use Lapack only for large matrices
  bool useLapack = (A.rowNum > vpMatrixf::m_lapack_min_size || A.colNum > vpMatrixf::m_lapack_min_size);
#if !(defined(VISP_HAVE_LAPACK) && !defined(VISP_HAVE_LAPACK_BUILT_IN) && !defined(VISP_HAVE_GSL))
  useLapack = false;
#endif
  ...
  if (useLapack) {
    ...
    vpMatrixf::blas_dgemv(trans, A.colNum, A.rowNum, alpha, A.data, A.colNum, v.data, incr, beta, w.data, incr);
#endif
  } else {
    w = 0.0;
...
/*!
  ...
  \sa operator*()
*/
void vpMatrixf::mult2Matrices(const vpMatrixf &A, const vpMatrixf &B, vpMatrixf &C)
{
  ...
  // If available use Lapack only for large matrices
  bool useLapack = (A.rowNum > vpMatrixf::m_lapack_min_size || A.colNum > vpMatrixf::m_lapack_min_size ||
                    B.colNum > vpMatrixf::m_lapack_min_size);
#if !(defined(VISP_HAVE_LAPACK) && !defined(VISP_HAVE_LAPACK_BUILT_IN) && !defined(VISP_HAVE_GSL))
  useLapack = false;
#endif
  ...
  if (useLapack) {
    ...
    const double beta = 0.0;
    const char trans = 'n';
    vpMatrixf::blas_dgemm(trans, trans, B.colNum, A.rowNum, A.colNum, alpha, B.data, B.colNum, A.data, A.colNum, beta,
                         C.data, B.colNum);
#endif
  } else {
...
*/
void vpMatrixf::mult2Matrices(const vpMatrixf &A, const vpMatrixf &B, vpRotationMatrix &C)
{
...
*/
void vpMatrixf::mult2Matrices(const vpMatrixf &A, const vpMatrixf &B, vpHomogeneousMatrix &C)
{
...
/*!
  ...
  \sa multMatrixVector()
*/
void vpMatrixf::mult2Matrices(const vpMatrixf &A, const vpColVectorf &B, vpColVectorf &C)
{
  vpMatrixf::multMatrixVector(A, B, C);
}
...
*/
vpMatrixf vpMatrixf::operator*(const vpMatrixf &B) const
{
  vpMatrixf C;

  vpMatrixf::mult2Matrices(*this, B, C);
...
*/
vpMatrixf vpMatrixf::operator*(const vpRotationMatrix &R) const
{
  if (colNum != R.getRows()) {
...
*/
vpMatrixf vpMatrixf::operator*(const vpHomogeneousMatrix &M) const
{
  if (colNum != M.getRows()) {
    throw(vpException(vpException::dimensionError, "Cannot multiply (%dx%d) matrix by (3x3) rotation matrix", rowNum,
                      colNum));
...
*/
vpMatrixf vpMatrixf::operator*(const vpVelocityTwistMatrix &V) const
{
  if (colNum != V.getRows()) {
  ...
  bool useLapack = (rowNum > vpMatrixf::m_lapack_min_size || colNum > vpMatrixf::m_lapack_min_size ||
                    V.colNum > vpMatrixf::m_lapack_min_size);
#if !(defined(VISP_HAVE_LAPACK) && !defined(VISP_HAVE_LAPACK_BUILT_IN) && !defined(VISP_HAVE_GSL))
  useLapack = false;
#endif
  ...
  if (useLapack) {
    ...
    const double beta = 0.0;
    const char trans = 'n';
    vpMatrixf::blas_dgemm(trans, trans, V.colNum, rowNum, colNum, alpha, V.data, V.colNum, data, colNum, beta, M.data,
                         M.colNum);
#endif
  } else {
...
/*!
  ...
  The matrix should be of dimension m-by-6.
*/
vpMatrixf vpMatrixf::operator*(const vpForceTwistMatrix &V) const
{
  if (colNum != V.getRows()) {
  ...
  // Speed up obtained using SSE2.
  bool useLapack = (rowNum > vpMatrixf::m_lapack_min_size || colNum > vpMatrixf::m_lapack_min_size ||
                    V.getCols() > vpMatrixf::m_lapack_min_size);
#if !(defined(VISP_HAVE_LAPACK) && !defined(VISP_HAVE_LAPACK_BUILT_IN) && !defined(VISP_HAVE_GSL))
  useLapack = false;
#endif
  ...
  if (useLapack) {
    ...
    const double beta = 0.0;
    const char trans = 'n';
    vpMatrixf::blas_dgemm(trans, trans, V.getCols(), rowNum, colNum, alpha, V.data, V.getCols(), data, colNum, beta,
                         M.data, M.colNum);
#endif
  } else {
    SimdMatMulTwist(data, rowNum, V.data, M.data);
...
void vpMatrixf::add2WeightedMatrices(const vpMatrixf &A, const double &wA, const vpMatrixf &B, const double &wB,
                                    vpMatrixf &C)
{
  if ((A.rowNum != C.rowNum) || (B.colNum != C.colNum))
    C.resize(A.rowNum, B.colNum, false, false);
...
/*!
  ...
  \sa operator+()
*/
void vpMatrixf::add2Matrices(const vpMatrixf &A, const vpMatrixf &B, vpMatrixf &C)
{
  if ((A.rowNum != C.rowNum) || (B.colNum != C.colNum))
    C.resize(A.rowNum, B.colNum, false, false);
...
/*!
  \warning This function is provided for compat with previous releases. You
  should rather use the functionalities provided in vpColVectorf class.
  ...
  \sa vpColVectorf::operator+()
*/
void vpMatrixf::add2Matrices(const vpColVectorf &A, const vpColVectorf &B, vpColVectorf &C)
{
  if ((A.rowNum != C.rowNum) || (B.colNum != C.colNum))
    C.resize(A.rowNum);
...
{
  vpMatrixf C;
  vpMatrixf::add2Matrices(*this, B, C);
  return C;
}
...
/*!
  ...
  \sa vpColVectorf::operator-()
*/
void vpMatrixf::sub2Matrices(const vpColVectorf &A, const vpColVectorf &B, vpColVectorf &C)
{
...
/*!
  ...
  \sa operator-()
*/
void vpMatrixf::sub2Matrices(const vpMatrixf &A, const vpMatrixf &B, vpMatrixf &C)
{
  if ((A.rowNum != C.rowNum) || (A.colNum != C.colNum))
...
{
  vpMatrixf C;
  vpMatrixf::sub2Matrices(*this, B, C);
  return C;
}

//! Operation A = A + B

vpMatrixf &vpMatrixf::operator+=(const vpMatrixf &B)
{
...
/*!
  ...
  \sa operator-(void)
*/
void vpMatrixf::negateMatrix(const vpMatrixf &A, vpMatrixf &C)
{
  if ((A.rowNum != C.rowNum) || (A.colNum != C.colNum))
    C.resize(A.rowNum, A.colNum, false, false);
...
*/
vpMatrixf vpMatrixf::operator-() const // negate
{
  vpMatrixf C;
  vpMatrixf::negateMatrix(*this, C);
  return C;
}

double vpMatrixf::sum() const
{
  double s = 0.0;
  for (unsigned int i = 0; i < rowNum; i++) {
    for (unsigned int j = 0; j < colNum; j++) {
...
*/
vpMatrixf operator*(const double &x, const vpMatrixf &B)
{
...
/*!
   ...
   by a scalar.
 */
vpMatrixf vpMatrixf::operator*(double x) const
{
  if (std::fabs(x - 1.) < std::numeric_limits<double>::epsilon()) {
    return (*this);
  }
...
/*!
  ...
  \param out : a vpColVectorf.
*/
void vpMatrixf::stackColumns(vpColVectorf &out)
{
...
/*!
  Stacks columns of a matrix in a vector.
  \return a vpColVectorf.
*/
vpColVectorf vpMatrixf::stackColumns()
{
  vpColVectorf out(colNum * rowNum);
  stackColumns(out);
  return out;
}
...
*/
void vpMatrixf::stackRows(vpRowVector &out)
{
...
*/
vpRowVector vpMatrixf::stackRows()
{
...
*/
vpMatrixf vpMatrixf::hadamard(const vpMatrixf &m) const
{
...
*/
void vpMatrixf::kron(const vpMatrixf &m1, const vpMatrixf &m2, vpMatrixf &out)
{
...
/*!
  ...
  \f$ m1 \otimes m2 \f$.
*/
void vpMatrixf::kron(const vpMatrixf &m, vpMatrixf &out) const { kron(*this, m, out); }
...
*/
vpMatrixf vpMatrixf::kron(const vpMatrixf &m1, const vpMatrixf &m2)
{
  unsigned int r1 = m1.getRows();
  unsigned int c1 = m1.getCols();
  unsigned int r2 = m2.getRows();
...
*/
vpMatrixf vpMatrixf::kron(const vpMatrixf &m) const { return kron(*this, m); }
...
\sa solveBySVD(const vpColVectorf &)
*/
void vpMatrixf::solveBySVD(const vpColVectorf &b, vpColVectorf &x) const { x = pseudoInverse(1e-6) * b; }
...
\sa solveBySVD(const vpColVectorf &, vpColVectorf &)
*/
vpColVectorf vpMatrixf::solveBySVD(const vpColVectorf &B) const
{
  vpColVectorf X(colNum);
...
*/
void vpMatrixf::svd(vpColVectorf &w, vpMatrixf &V)
{
...
Rank: 2
  \endcode
*/
unsigned int vpMatrixf::pseudoInverse(vpMatrixf &Ap, double svThreshold) const
{
#if defined(VISP_HAVE_LAPACK)
...
Rank out: 2
  \endcode
*/
int vpMatrixf::pseudoInverse(vpMatrixf &Ap, int rank_in) const
{
#if defined(VISP_HAVE_LAPACK)
...
*/
vpMatrixf vpMatrixf::pseudoInverse(double svThreshold) const
{
#if defined(VISP_HAVE_LAPACK)
...
int main()
{
  ...
  int rank_in = 2;
  vpMatrixf A_p = A.pseudoInverseLapack(rank_in);
...
*/
vpMatrixf vpMatrixf::pseudoInverse(int rank_in) const
{
#if defined(VISP_HAVE_LAPACK)
...
int main()
{
  ...
  vpMatrixf A_p = A.pseudoInverseLapack();
...
*/
vpMatrixf vpMatrixf::pseudoInverseLapack(double svThreshold) const
{
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, double) const
*/
unsigned int vpMatrixf::pseudoInverseLapack(vpMatrixf &Ap, double svThreshold) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, vpColVectorf &, double) const
*/
unsigned int vpMatrixf::pseudoInverseLapack(vpMatrixf &Ap, vpColVectorf &sv, double svThreshold) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  vpMatrixf S(rank, A.getCols());
  for(unsigned int i = 0; i< rank; i++)
    S[i][i] = sv[i];
  vpMatrixf Vt(A.getCols(), A.getCols());
  ...
  \sa pseudoInverse(vpMatrixf &, vpColVectorf &, double, vpMatrixf &, vpMatrixf &, vpMatrixf &) const
*/
unsigned int vpMatrixf::pseudoInverseLapack(vpMatrixf &Ap, vpColVectorf &sv, double svThreshold, vpMatrixf &imA,
                                           vpMatrixf &imAt, vpMatrixf &kerAt) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
*/
vpMatrixf vpMatrixf::pseudoInverseLapack(int rank_in) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, int) const
*/
int vpMatrixf::pseudoInverseLapack(vpMatrixf &Ap, int rank_in) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, vpColVectorf &, int) const
*/
int vpMatrixf::pseudoInverseLapack(vpMatrixf &Ap, vpColVectorf &sv, int rank_in) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, vpColVectorf &, int, vpMatrixf &, vpMatrixf &, vpMatrixf &) const
*/
int vpMatrixf::pseudoInverseLapack(vpMatrixf &Ap, vpColVectorf &sv, int rank_in, vpMatrixf &imA, vpMatrixf &imAt,
...
int main()
{
  ...
  vpMatrixf A_p = A.pseudoInverseEigen3();
...
*/
vpMatrixf vpMatrixf::pseudoInverseEigen3(double svThreshold) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, double) const
*/
unsigned int vpMatrixf::pseudoInverseEigen3(vpMatrixf &Ap, double svThreshold) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, vpColVectorf &, double) const
*/
unsigned int vpMatrixf::pseudoInverseEigen3(vpMatrixf &Ap, vpColVectorf &sv, double svThreshold) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, vpColVectorf &, double, vpMatrixf &, vpMatrixf &, vpMatrixf &) const
*/
unsigned int vpMatrixf::pseudoInverseEigen3(vpMatrixf &Ap, vpColVectorf &sv, double svThreshold, vpMatrixf &imA,
                                           vpMatrixf &imAt, vpMatrixf &kerAt) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
...
int main()
{
  ...
  int rank_in = 2;
  vpMatrixf A_p = A.pseudoInverseEigen3(rank_in);
  ...
  \sa pseudoInverse(int) const
*/
vpMatrixf vpMatrixf::pseudoInverseEigen3(int rank_in) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, int) const
*/
int vpMatrixf::pseudoInverseEigen3(vpMatrixf &Ap, int rank_in) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, vpColVectorf &, int) const
*/
int vpMatrixf::pseudoInverseEigen3(vpMatrixf &Ap, vpColVectorf &sv, int rank_in) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, vpColVectorf &, int, vpMatrixf &, vpMatrixf &, vpMatrixf &) const
*/
int vpMatrixf::pseudoInverseEigen3(vpMatrixf &Ap, vpColVectorf &sv, int rank_in, vpMatrixf &imA, vpMatrixf &imAt,
                                  vpMatrixf &kerAt) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
...
int main()
{
  ...
  \sa pseudoInverse(double) const
*/
vpMatrixf vpMatrixf::pseudoInverseOpenCV(double svThreshold) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, double) const
*/
unsigned int vpMatrixf::pseudoInverseOpenCV(vpMatrixf &Ap, double svThreshold) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, vpColVectorf &, double) const
*/
unsigned int vpMatrixf::pseudoInverseOpenCV(vpMatrixf &Ap, vpColVectorf &sv, double svThreshold) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, vpColVectorf &, double, vpMatrixf &, vpMatrixf &, vpMatrixf &) const
*/
unsigned int vpMatrixf::pseudoInverseOpenCV(vpMatrixf &Ap, vpColVectorf &sv, double svThreshold, vpMatrixf &imA,
                                           vpMatrixf &imAt, vpMatrixf &kerAt) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
...
int main()
{
  ...
  int rank_in = 2;
  vpMatrixf A_p = A.pseudoInverseOpenCV(rank_in);
  ...
  \sa pseudoInverse(int) const
*/
vpMatrixf vpMatrixf::pseudoInverseOpenCV(int rank_in) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, int) const
*/
int vpMatrixf::pseudoInverseOpenCV(vpMatrixf &Ap, int rank_in) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, vpColVectorf &, int) const
*/
int vpMatrixf::pseudoInverseOpenCV(vpMatrixf &Ap, vpColVectorf &sv, int rank_in) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
  int rank_out;
...
int main()
{
  ...
  \sa pseudoInverse(vpMatrixf &, vpColVectorf &, int, vpMatrixf &, vpMatrixf &, vpMatrixf &) const
*/
int vpMatrixf::pseudoInverseOpenCV(vpMatrixf &Ap, vpColVectorf &sv, int rank_in, vpMatrixf &imA, vpMatrixf &imAt,
                                  vpMatrixf &kerAt) const
{
  unsigned int nrows = getRows();
  unsigned int ncols = getCols();
...
Singular values: 6.874359351  4.443330227
  \endcode
*/
unsigned int vpMatrixf::pseudoInverse(vpMatrixf &Ap, vpColVectorf &sv, double svThreshold) const
{
#if defined(VISP_HAVE_LAPACK)
...
Singular values: 6.874359351  4.443330227
  \endcode
*/
int vpMatrixf::pseudoInverse(vpMatrixf &Ap, vpColVectorf &sv, int rank_in) const
{
#if defined(VISP_HAVE_LAPACK)
...
/*!
  ...
  See pseudoInverse(vpMatrixf &, vpColVectorf &, double, vpMatrixf &, vpMatrixf &, vpMatrixf &) const
...
Im(A^T): [3,2]=
  ...
  \endcode
*/
unsigned int vpMatrixf::pseudoInverse(vpMatrixf &Ap, vpColVectorf &sv, double svThreshold, vpMatrixf &imA,
                                     vpMatrixf &imAt) const
{
  vpMatrixf kerAt;
...
Im(A^T): [3,2]=
  ...
  \endcode
*/
int vpMatrixf::pseudoInverse(vpMatrixf &Ap, vpColVectorf &sv, int rank_in, vpMatrixf &imA, vpMatrixf &imAt) const
{
  vpMatrixf kerAt;
...
Im(A) * S * [Im(A^T) | Ker(A)]^T:[2,3]=
  ...
  \endcode
*/
unsigned int vpMatrixf::pseudoInverse(vpMatrixf &Ap, vpColVectorf &sv, double svThreshold, vpMatrixf &imA, vpMatrixf &imAt,
                                     vpMatrixf &kerAt) const
{
#if defined(VISP_HAVE_LAPACK)
...
Im(A) * S * [Im(A^T) | Ker(A)]^T:[2,3]=
  ...
  \endcode
*/
int vpMatrixf::pseudoInverse(vpMatrixf &Ap, vpColVectorf &sv, int rank_in, vpMatrixf &imA, vpMatrixf &imAt,
                            vpMatrixf &kerAt) const
{
#if defined(VISP_HAVE_LAPACK)
...
int main()
{
  ...
  vpColVectorf cv = A.getCol(1, 1, 3);
...
13
  \endcode
 */
vpColVectorf vpMatrixf::getCol(unsigned int j, unsigned int i_begin, unsigned int column_size) const
{
...
13
  \endcode
 */
vpColVectorf vpMatrixf::getCol(unsigned int j) const { return getCol(j, 0, rowNum); }
...
4  5  6  7
  \endcode
 */
vpRowVector vpMatrixf::getRow(unsigned int i) const { return getRow(i, 0, colNum); }
...
5  6  7
  \endcode
 */
vpRowVector vpMatrixf::getRow(unsigned int i, unsigned int j_begin, unsigned int row_size) const
{
...
0  5  10
  \endcode
 */
vpColVectorf vpMatrixf::getDiag() const
{
...
*/
vpMatrixf vpMatrixf::stack(const vpMatrixf &A, const vpMatrixf &B)
{
  vpMatrixf C;

  vpMatrixf::stack(A, B, C);
...
*/
void vpMatrixf::stack(const vpMatrixf &A, const vpMatrixf &B, vpMatrixf &C)
{
...
*/
vpMatrixf vpMatrixf::stack(const vpMatrixf &A, const vpRowVector &r)
{
  vpMatrixf C;
  vpMatrixf::stack(A, r, C);
...
/*!
  ...
  different objects.
*/
void vpMatrixf::stack(const vpMatrixf &A, const vpRowVector &r, vpMatrixf &C)
{
  if (A.data != NULL && A.data == C.data) {
    std::cerr << "A and C must be two different objects!" << std::endl;
    return;
...
*/
vpMatrixf vpMatrixf::stack(const vpMatrixf &A, const vpColVectorf &c)
{
  vpMatrixf C;
  vpMatrixf::stack(A, c, C);
...
/*!
  ...
  different objects.
*/
void vpMatrixf::stack(const vpMatrixf &A, const vpColVectorf &c, vpMatrixf &C)
{
  if (A.data != NULL && A.data == C.data) {
    std::cerr << "A and C must be two different objects!" << std::endl;
    return;
...
/*!
  ...
  insertion.
*/
vpMatrixf vpMatrixf::insert(const vpMatrixf &A, const vpMatrixf &B, unsigned int r, unsigned int c)
{
  vpMatrixf C;
...
/*!
  ...
  allow the insertion.
*/
void vpMatrixf::insert(const vpMatrixf &A, const vpMatrixf &B, vpMatrixf &C, unsigned int r, unsigned int c)
{
...
*/
vpMatrixf vpMatrixf::juxtaposeMatrices(const vpMatrixf &A, const vpMatrixf &B)
{
  vpMatrixf C;
...
/*!
  ...
  \warning A and B must have the same number of rows.
*/
void vpMatrixf::juxtaposeMatrices(const vpMatrixf &A, const vpMatrixf &B, vpMatrixf &C)
{
...
*/
int vpMatrixf::print(std::ostream &s, unsigned int length, const std::string &intro) const
{
...
>>
  \endcode
*/
std::ostream &vpMatrixf::matlabPrint(std::ostream &os) const
{
  os << "[ ";
...
*/
std::ostream &vpMatrixf::maplePrint(std::ostream &os) const
{
  os << "([ " << std::endl;
  for (unsigned int i = 0; i < this->getRows(); ++i) {
    os << "[";
...
3, 4, 5
  \endcode
*/
std::ostream &vpMatrixf::csvPrint(std::ostream &os) const
{
  for (unsigned int i = 0; i < this->getRows(); ++i) {
    for (unsigned int j = 0; j < this->getCols(); ++j) {
      os << (*this)[i][j];
...
M[1][2] = 5;
  ...
  \endcode
*/
std::ostream &vpMatrixf::cppPrint(std::ostream &os, const std::string &matrixName, bool octet) const
{
  os << "vpMatrixf " << matrixName << " (" << this->getRows() << ", " << this->getCols() << "); " << std::endl;
...
*/
void vpMatrixf::stack(const vpMatrixf &A)
{
  if (rowNum == 0) {
    *this = A;
  } else if (A.getRows() > 0) {
...
\endcode
*/
void vpMatrixf::stack(const vpRowVector &r)
{
  if (rowNum == 0) {
    *this = r;
  } else {
...
*/
void vpMatrixf::stack(const vpColVectorf &c)
{
  if (colNum == 0) {
    *this = c;
  } else {
...
*/
void vpMatrixf::insert(const vpMatrixf &A, unsigned int r, unsigned int c)
{
...
int main()
{
  vpMatrixf A(3,3); // A is a symmetric matrix
  ...
  vpColVectorf evalue; // Eigenvalues
  evalue = A.eigenValues();
  std::cout << "Eigen values: \n" << evalue << std::endl;
}
\endcode

  \sa eigenValues(vpColVectorf &, vpMatrixf &)

*/
vpColVectorf vpMatrixf::eigenValues() const
{
  vpColVectorf evalue(rowNum); // Eigen values
...
#else
  {
    ...
    int info = 0;
    double wkopt;
    vpMatrixf::blas_dsyev(jobz, uplo, rowNum, A.data, colNum, evalue.data, &wkopt, lwork, info);
    lwork = static_cast<int>(wkopt);
    WORK.resize(lwork);
    vpMatrixf::blas_dsyev(jobz, uplo, rowNum, A.data, colNum, evalue.data, WORK.data, lwork, info);
  }
#endif
#else
  {
...
int main()
{
  vpMatrixf A(4,4); // A is a symmetric matrix
  ...
  vpColVectorf d; // Eigenvalues
  vpMatrixf    V; // Eigenvectors
...
\sa eigenValues()
*/
void vpMatrixf::eigenValues(vpColVectorf &evalue, vpMatrixf &evector) const
{
  if (rowNum != colNum) {
    throw(vpException(vpException::dimensionError, "Cannot compute eigen values on a non square matrix (%dx%d)", rowNum,
                      colNum));
...
/*!
  ...
  \return The rank of the matrix.
*/
unsigned int vpMatrixf::kernel(vpMatrixf &kerAt, double svThreshold) const
{
  unsigned int nbline = getRows();
  unsigned int nbcol = getCols();

  vpMatrixf U, V; // Copy of the matrix, SVD function is destructive
  vpColVectorf sv;
...
*/
unsigned int vpMatrixf::nullSpace(vpMatrixf &kerA, double svThreshold) const
{
...
*/
unsigned int vpMatrixf::nullSpace(vpMatrixf &kerA, int dim) const
{
  unsigned int nbrow = getRows();
  unsigned int nbcol = getCols();
...
\endcode
*/
double vpMatrixf::det(vpDetMethod method) const
{
  double det = 0.;
...
*/
vpMatrixf vpMatrixf::expm() const
{
  if (colNum != rowNum) {
    ...
    return expA;
#else
    vpMatrixf _expE(rowNum, colNum, false);
    vpMatrixf _expD(rowNum, colNum, false);
    vpMatrixf _expX(rowNum, colNum, false);
    vpMatrixf _expcX(rowNum, colNum, false);
    vpMatrixf _eye(rowNum, colNum, false);
...
*/
vpMatrixf subblock(const vpMatrixf &M, unsigned int col, unsigned int row)
{
  vpMatrixf M_comp;
 ...
 */
double vpMatrixf::cond(double svThreshold) const
{
  unsigned int nbline = getRows();
  unsigned int nbcol = getCols();
 ...
 */
void vpMatrixf::computeHLM(const vpMatrixf &H, const double &alpha, vpMatrixf &HLM)
{
...
*/
double vpMatrixf::frobeniusNorm() const
{
  double norm = 0.0;
...
*/
double vpMatrixf::inducedL2Norm() const
{
  if (this->dsize != 0) {
    vpMatrixf v;
    vpColVectorf w;
...
*/
double vpMatrixf::infinityNorm() const
{
  double norm = 0.0;
  for (unsigned int i = 0; i < rowNum; i++) {
    double x = 0;
...
/*!
  ...
  */
double vpMatrixf::sumSquare() const
{
...
/*!
  ...
  \image html vpMatrixf-conv2-mode.jpg "Convolution mode: full, same, valid (image credit: Theano doc)."

  \note This is a very basic implementation that does not use FFT.
 */
vpMatrixf vpMatrixf::conv2(const vpMatrixf &M, const vpMatrixf &kernel, const std::string &mode)
{
  vpMatrixf res;
...
/*!
  ...
  \note This is a very basic implementation that does not use FFT.
 */
void vpMatrixf::conv2(const vpMatrixf &M, const vpMatrixf &kernel, vpMatrixf &res, const std::string &mode)
{
...
*/
vp_deprecated double vpMatrixf::euclideanNorm() const { return frobeniusNorm(); }

vpMatrixf vpMatrixf::stackMatrices(const vpColVectorf &A, const vpColVectorf &B)
{
  return (vpMatrixf)(vpColVectorf::stack(A, B));
}

void vpMatrixf::stackMatrices(const vpColVectorf &A, const vpColVectorf &B, vpColVectorf &C)
{
  vpColVectorf::stack(A, B, C);
}

vpMatrixf vpMatrixf::stackMatrices(const vpMatrixf &A, const vpRowVector &B) { return vpMatrixf::stack(A, B); }

void vpMatrixf::stackMatrices(const vpMatrixf &A, const vpRowVector &B, vpMatrixf &C) { vpMatrixf::stack(A, B, C); }
...
*/
vpRowVector vpMatrixf::row(unsigned int i)
{
...
*/
vpColVectorf vpMatrixf::column(unsigned int j)
{
  vpColVectorf c(getRows());
...
*/
void vpMatrixf::setIdentity(const double &val)
{
  for (unsigned int i = 0; i < rowNum; i++)
    for (unsigned int j = 0; j < colNum; j++)
      if (i == j)
