...
void
vpImageTools::imageBitwiseAnd(const vpImage<unsigned char> &I1,
                            const vpImage<unsigned char> &I2,
                            vpImage<unsigned char> &Ires) {
  if (I1.getSize() == 0) {
    std::cerr << "I1 input image is empty!" << std::endl;
  ...
  if (Ires.getSize() >= 16) {
    for (; cpt <= Ires.getSize() - 16 ; cpt += 16, ptr_I1 += 16, ptr_I2 += 16, ptr_Ires += 16) {
      const __m128i v1   = _mm_loadu_si128( (const __m128i*) ptr_I1);
      const __m128i v2   = _mm_loadu_si128( (const __m128i*) ptr_I2);
      const __m128i vres = _mm_and_si128(v1, v2);
...
void
vpImageTools::imageBitwiseOr(const vpImage<unsigned char> &I1,
                             const vpImage<unsigned char> &I2,
                             vpImage<unsigned char> &Ires) {
  if (I1.getSize() == 0) {
    std::cerr << "I1 input image is empty!" << std::endl;
  ...
  if (Ires.getSize() >= 16) {
    for (; cpt <= Ires.getSize() - 16 ; cpt += 16, ptr_I1 += 16, ptr_I2 += 16, ptr_Ires += 16) {
      const __m128i v1   = _mm_loadu_si128( (const __m128i*) ptr_I1);
      const __m128i v2   = _mm_loadu_si128( (const __m128i*) ptr_I2);
      const __m128i vres = _mm_or_si128(v1, v2);
...
void
vpImageTools::imageBitwiseXor(const vpImage<unsigned char> &I1,
                              const vpImage<unsigned char> &I2,
                              vpImage<unsigned char> &Ires) {
  if (I1.getSize() == 0) {
    std::cerr << "I1 input image is empty!" << std::endl;
  ...
  if (Ires.getSize() >= 16) {
    for (; cpt <= Ires.getSize() - 16 ; cpt += 16, ptr_I1 += 16, ptr_I2 += 16, ptr_Ires += 16) {
      const __m128i v1   = _mm_loadu_si128( (const __m128i*) ptr_I1);
      const __m128i v2   = _mm_loadu_si128( (const __m128i*) ptr_I2);
      const __m128i vres = _mm_xor_si128(v1, v2);
